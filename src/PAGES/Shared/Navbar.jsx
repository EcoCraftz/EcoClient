...
const Navbar = () => {
    ...
    const navItem = <>
        ...
        <li className='lg:border-2 lg:border-black rounded-xl mx-1'><NavLink to='/'>
            Home</NavLink></li>
        <li id='parent' className='lg:border-2 lg:border-black rounded-xl mx-1'>
        ...
        <li className='lg:border-2 lg:border-black rounded-xl mx-1'><NavLink to='/csr'>CSR</NavLink></li>
        <li className='lg:border-2 lg:border-black rounded-xl mx-1'><NavLink to='/covid'>Covid-19</NavLink></li>
        <li className='lg:border-2 lg:border-black rounded-xl mx-1'><NavLink to='/career'>Career</NavLink></li>
        {/* <li className='lg:border-2 lg:border-black rounded-ss-2xl rounded-ee-2xl mx-1'><NavLink to='/contact'>Contact</NavLink></li> */}
        <li className='lg:border-2 lg:border-black rounded-xl mx-1'><NavLink to='/about'>About Us</NavLink></li>
    ...
    return (
        <div style={{ height: 'auto' }} className='flex flex-row justify-center items-center w-full sticky top-0 z-20'>
            <div className="navbar bg-gradient-to-r from-green-400 via-cyan-600 to-blue-400">
